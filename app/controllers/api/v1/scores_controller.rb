class Api::V1::ScoresController < Api::V1::ApplicationController
  # adding Api::V1:: to ApplicationController looks for it in api/v1 folder. Can also leave it off and leave file in main folder and will look for it there (same file applies to all versions)
  def index
    @scores = Score.all
